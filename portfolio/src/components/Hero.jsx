        ...
        <div className="relative mx-auto hidden w-full max-w-md lg:block">
          ...
          <div className="glass-card relative animate-float overflow-hidden p-6 shadow-glow">
            <div className="flex items-center gap-2 border-b border-white/10 pb-4">
              ...
              <span className="ml-auto font-mono text-[10px] text-slate-600">thanh_profile.c</span>
            </div>

            <pre className="overflow-hidden py-7 font-mono text-[13px] leading-7 text-slate-400">
              <code>
                <span className="text-violet">struct</span> <span className="text-cyan">Engineer</span> {'{'}{`\n`}
                ...
                {'    '}<span className="text-emerald-300">&quot;STM32 firmware&quot;</span>,{`\n`}
                {'    '}<span className="text-emerald-300">&quot;Computer vision&quot;</span>,{`\n`}
                {'    '}<span className="text-emerald-300">&quot;IoT interfaces&quot;</span>{`\n`}
                {'  '}{'}'};{`\n`}
                {'  '}<span className="text-blue-300">bool</span> keepLearning = <span className="text-violet">true</span>;{`\n`}
                {'}'};<span className="ml-1 inline-block h-4 w-2 animate-blink bg-cyan align-middle" />
              </code>
            </pre>

            <div className="flex items-center justify-between border-t border-white/10 pt-4 font-mono text-[10px] uppercase tracking-wider text-slate-600">
